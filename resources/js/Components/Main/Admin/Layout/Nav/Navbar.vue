        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        href: 'admin.invoices606.create',
                        active: route().current('admin.invoices606.create'),
                        activeClass: '/admin/invoices-606/create',
                        label: '606 de terceros',
                        children: [],
                        icon: '',
                        permissions: ['admin.invoices.create_606'],
                        visible: true
                    },
                ],
                icon: '',
