...
use App\Http\Controllers\Admin\InternalAPI\V2\InvoiceCompareController as InvoiceCompareControllerV2;
...
Route::resource('invoices-compare', InvoiceCompareController::class)
    ->only('index')
    ->names('admin.invoicescompare');

Route::prefix('v2')->group(function () {
   Route::resource('invoices-compare', InvoiceCompareControllerV2::class)
    ->only('index')
    ->names('admin.v2.invoicescompare');
});
...
Route::post('api/v2/invoices-compare/compare', [InvoiceCompareControllerV2::class, 'compare'])->name('api.v2.invoicescompare.compare');
